...
5. **`dedupe-investigations.md`**: archive the PR-#1 portion. Extract documented #2 (dispatch-time 409 guard) and #3 (UI cooldown) into a single short spec at `docs/proposals/audit-dedupe-followups.md` so they don't get lost in the archive.
